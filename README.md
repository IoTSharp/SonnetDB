...
- 🛠️ Web Admin Workbench：Schema Explorer、SQL Editor、Staged Preview、Result Grid，Copilot 继续保持原来的全局浮窗。
...
Web Admin Workbench（Schema Explorer / SQL Editor / Staged Preview / Result Grid）说明与验收清单见 [docs/web-workbench.md](docs/web-workbench.md)。
