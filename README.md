...
Web Admin Workbench（Schema Explorer / SQL Editor / Staged Preview / Result Grid / Trajectory 模式）说明见 [docs/web-workbench.md](docs/web-workbench.md)。
...
| Web Admin、SQL 工作台、Copilot | [SonnetDB Workbench](docs/web-workbench.md) |
