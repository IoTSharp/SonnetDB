...
| Graph Beta、SQL/PGQ、GQL 风格查询与 GraphRAG 合同 | [Graph GQL 风格查询入口](docs/m40-graph-364-gql-entry.md)、[知识图谱与 GraphRAG 合同](docs/m40-graph-365-knowledge-contract.md)、[原生属性图路线与边界](docs/native-graph-database-roadmap.md) |
