...
- current-statement and selection SQL execution with schema-aware completion, C# parser diagnostics, hover, and `EXPLAIN`
...
The optional machine-level path accepts a `SonnetDB.LanguageServer` executable, DLL, or project file for local development. Workspace settings are intentionally ignored for this executable path.
