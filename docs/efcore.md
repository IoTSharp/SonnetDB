...
- IoTSharp 一类的整体迁移可参考兼容性测试 `tests/SonnetDB.IoTSharpCompat.Tests/ApplicationDbContextSonnetDbCompatTests.cs`，里面给出了与 `IdentityUser`、`AddIdentity`、`DataBaseModelBuilderOptions` 的完整接线方式。
