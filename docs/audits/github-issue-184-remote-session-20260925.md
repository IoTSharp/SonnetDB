...
Repository: `https://github.com/IoTSharp/SonnetDB.git`. Branch: `codex/issue-184-remote-tx`. This extends the earlier [conditional UPSERT audit](github-issue-184-conditional-upsert-20260925.md). The public Issue remains open until integration and deployment review.
