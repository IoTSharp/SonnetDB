...
[JsonSerializable(typeof(RagManagementRequest))]
[JsonSerializable(typeof(RagManagementProfile))]
[JsonSerializable(typeof(RagManagementProfiles))]
[JsonSerializable(typeof(RagManagementPending))]
[JsonSerializable(typeof(RagManagementStatus))]
[JsonSerializable(typeof(RagManagementResult))]
[JsonSerializable(typeof(RagManagementAuditEntry))]
[JsonSerializable(typeof(RagManagementAuditPage))]
...
[JsonSerializable(typeof(GraphLabelStatisticDto))]
[JsonSerializable(typeof(GraphIndexStatisticDto))]
[JsonSerializable(typeof(GraphDegreeBucketDto))]
[JsonSerializable(typeof(GraphSlowTraversalDto))]
[JsonSerializable(typeof(GraphOperationsCapabilitiesDto))]
[JsonSerializable(typeof(GraphOperationsOverviewDto))]
[JsonSerializable(typeof(GraphVisualizationDto))]
[JsonSerializable(typeof(GraphMaintenanceStageRequest))]
[JsonSerializable(typeof(GraphMaintenanceDecisionRequest))]
[JsonSerializable(typeof(GraphMaintenanceExecutionDto))]
[JsonSerializable(typeof(GraphMaintenanceApprovalDto))]
[JsonSerializable(typeof(GraphMaintenanceAuditListDto))]
[JsonSerializable(typeof(List<GraphLabelStatisticDto>))]
[JsonSerializable(typeof(List<GraphIndexStatisticDto>))]
[JsonSerializable(typeof(List<GraphDegreeBucketDto>))]
[JsonSerializable(typeof(List<GraphSlowTraversalDto>))]
[JsonSerializable(typeof(List<GraphMaintenanceApprovalDto>))]
...
[JsonSerializable(typeof(KvConditionalSetRequest))]
[JsonSerializable(typeof(KvConditionalSetResponse))]
[JsonSerializable(typeof(KvExchangeResponse))]
...
[JsonSerializable(typeof(DocumentFindOneAndUpdateRequest))]
[JsonSerializable(typeof(DocumentFindOneAndUpdateResponse))]
[JsonSerializable(typeof(DocumentBulkWriteOperationContract))]
[JsonSerializable(typeof(DocumentBulkWriteRequest))]
[JsonSerializable(typeof(DocumentBulkWriteItemResponse))]
[JsonSerializable(typeof(DocumentBulkWriteResponse))]
[JsonSerializable(typeof(DocumentUpdatePreviewRequest))]
[JsonSerializable(typeof(DocumentUpdatePreviewItemResponse))]
[JsonSerializable(typeof(DocumentUpdatePreviewResponse))]
[JsonSerializable(typeof(DocumentIndexPartialFilterContract))]
[JsonSerializable(typeof(DocumentIndexCreateRequest))]
[JsonSerializable(typeof(DocumentIndexOperationResponse))]
[JsonSerializable(typeof(DocumentIndexConsistencyItemResponse))]
[JsonSerializable(typeof(DocumentIndexConsistencyResponse))]
[JsonSerializable(typeof(DocumentChangeFeedRequest))]
[JsonSerializable(typeof(DocumentChangeFeedItemResponse))]
[JsonSerializable(typeof(DocumentChangeFeedResponse))]
...
[JsonSerializable(typeof(DocumentAggregateComputedFieldContract))]
[JsonSerializable(typeof(DocumentAggregateExpressionContract))]
...
[JsonSerializable(typeof(List<DocumentBulkWriteOperationContract>))]
[JsonSerializable(typeof(List<DocumentBulkWriteItemResponse>))]
[JsonSerializable(typeof(List<DocumentItemResponse>))]
[JsonSerializable(typeof(List<DocumentUpdatePreviewItemResponse>))]
[JsonSerializable(typeof(List<DocumentIndexConsistencyItemResponse>))]
[JsonSerializable(typeof(List<DocumentChangeFeedItemResponse>))]
...
[JsonSerializable(typeof(List<DocumentAggregateComputedFieldContract>))]
[JsonSerializable(typeof(List<DocumentAggregateExpressionContract>))]
...
[JsonSerializable(typeof(MqMonitorResponse))]
[JsonSerializable(typeof(MqConsumerMonitorInfo))]
[JsonSerializable(typeof(List<MqConsumerMonitorInfo>))]
[JsonSerializable(typeof(MqRetentionPolicyInfo))]
[JsonSerializable(typeof(MqDeadLetterInfo))]
...
[JsonSerializable(typeof(MultipartUploadSessionResponse))]
[JsonSerializable(typeof(MultipartUploadListResponse))]
[JsonSerializable(typeof(List<MultipartPartResponse>))]
[JsonSerializable(typeof(List<MultipartUploadSessionResponse>))]
...
[JsonSerializable(typeof(SlowQueryDiagnosticEntry))]
[JsonSerializable(typeof(SlowQueryListResponse))]
[JsonSerializable(typeof(TopQueryDiagnosticEntry))]
[JsonSerializable(typeof(TopQueryListResponse))]
[JsonSerializable(typeof(List<SlowQueryDiagnosticEntry>))]
[JsonSerializable(typeof(List<TopQueryDiagnosticEntry>))]
[JsonSerializable(typeof(DiagnosticDumpResponse))]
[JsonSerializable(typeof(ProcessDiagnosticSnapshot))]
[JsonSerializable(typeof(GcDiagnosticSnapshot))]
[JsonSerializable(typeof(ThreadPoolDiagnosticSnapshot))]
[JsonSerializable(typeof(CopilotRuntimeDiagnosticSnapshot))]
[JsonSerializable(typeof(DatabaseDiagnosticSnapshot))]
[JsonSerializable(typeof(WalFileDiagnosticEntry))]
...
[JsonSerializable(typeof(TableForeignKeyInfo))]
[JsonSerializable(typeof(ViewInfo))]
[JsonSerializable(typeof(MaterializedViewInfo))]
...
[JsonSerializable(typeof(List<TableForeignKeyInfo>))]
[JsonSerializable(typeof(List<ViewInfo>))]
[JsonSerializable(typeof(List<MaterializedViewInfo>))]
...
[JsonSerializable(typeof(CopilotModelResponse))]
[JsonSerializable(typeof(CopilotModelGroupResponse))]
...
[JsonSerializable(typeof(ObjectEmbeddingRequest))]
[JsonSerializable(typeof(ObjectEmbeddingResponse))]
[JsonSerializable(typeof(SemanticEmbeddingAuditEntry))]
[JsonSerializable(typeof(SemanticEmbeddingAuditPage))]
...
[JsonSerializable(typeof(CopilotConversationUpsertRequest))]
[JsonSerializable(typeof(CopilotConversationResponse))]
[JsonSerializable(typeof(CopilotConversationListResponse))]
[JsonSerializable(typeof(List<CopilotConversationResponse>))]
[JsonSerializable(typeof(CopilotMessageResponse))]
[JsonSerializable(typeof(CopilotMessageListResponse))]
[JsonSerializable(typeof(List<CopilotMessageResponse>))]
[JsonSerializable(typeof(CopilotMetricsResponse))]
[JsonSerializable(typeof(CopilotModelMetricsResponse))]
[JsonSerializable(typeof(List<CopilotModelMetricsResponse>))]
...
[JsonSerializable(typeof(CopilotCloudUsage))]
