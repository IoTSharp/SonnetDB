...
public static class FunctionRegistry
{
    ...
    [
        ...
        new BuiltInScalarFunction("current_utc_datetime", 0, 0, SqlDateTimeFunctions.CurrentUtcDateTime),
        new BuiltInScalarFunction("current_datetime_offset", 0, 0, SqlDateTimeFunctions.CurrentDateTimeOffset),
        new BuiltInScalarFunction("current_utc_datetime_offset", 0, 0, SqlDateTimeFunctions.CurrentUtcDateTimeOffset),
        ...
        new BuiltInScalarFunction("to_unix_seconds", 1, 1, SqlDateTimeFunctions.ToUnixTimeSeconds),
